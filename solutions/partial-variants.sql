-- Warianty progow CZESCIOWYCH z klucza CKE - Matura czerwiec 2021, zad. 6 (task6), plik 1.
-- Podzadania nieprobowane niosa zapytanie WZORCOWE (kontrola pozytywna w tym samym przebiegu).
--   task_3 - 1 pkt "za poprawne wyniki" (bez zaokraglenia i bez sortowania malejacego)
--   task_5 - 1 pkt "za poprawne zestawienie nazw zespolow" (liczby bledne)
...
-- task_3 BEGIN
-- Poprawne srednie, ale bez ROUND i posortowane alfabetycznie.
...
-- task_5 BEGIN
-- Poprawne nazwy zespolow, obie liczby zawyzone o 1.
SELECT z.nazwa,
